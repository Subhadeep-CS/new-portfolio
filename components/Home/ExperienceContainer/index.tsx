...
const ExperienceContainer = () => {
  ...
  return (
    <section className="divide-y divide-zinc-200 dark:divide-zinc-800 border-y border-zinc-200 dark:border-zinc-800 relative z-0">
      ...
      <div className="container border-x border-zinc-200 dark:border-zinc-800 relative" ref={containerRef}>
        ...
        <div className="flex flex-col gap-6 w-full max-w-4xl">
          {EXPERIENCE_DATA.map((experience, index) => (
            <motion.div
              ...
              key={index}
              className="bg-white dark:bg-zinc-950 p-2 sm:p-4 shadow-sm"
            >
