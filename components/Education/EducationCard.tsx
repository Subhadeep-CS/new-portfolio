    ...
    <div className="relative pl-12 pb-12 last:pb-0 group/edu">
      ...
      >
        <div className="flex flex-col gap-1 pt-1">
          <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 group-hover/edu:text-blue-600 dark:group-hover/edu:text-blue-400 transition-colors">
            {education.institution}
          </h3>
          <div className="flex flex-wrap items-center gap-2 text-[15px] font-medium text-zinc-500 dark:text-zinc-500">
